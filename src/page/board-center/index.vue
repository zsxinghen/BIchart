...
<template>
  <div class="board-center">
        ...
        <div v-if="currentFile.reportType=='自定义'" style="height:100%;position:relative;">
          <div class="main-body" :style="{'background':setBg(),'height':'100%','background-size': 'cover','opacity':configData.bgConfig.opacticy?configData.bgConfig.opacticy:1}">
            <el-dropdown @command="handleCommand" placement="bottom-end">
              <span class="el-dropdown-link" v-show="!isToolbar">
    ...
    <board-config-authorization :board="currentNode" ref="authorization"></board-config-authorization>
  </div>
</template>
<script>
  import {
  ...
  import {
    default as urls
  } from "../../api/urls/board-center.js";
  import {
    default as layoutUrls
  } from "../../api/urls/layout-center.js";
  ...
  export default {
    ...
    methods: {
      ...
      // 重新获取当前看板信息
      reGetBoard(data, id) {
        this.$refs.sidebar.getDesign({ ...data,
          reportType: "自定义"
        }, id);
      },
      setBg() {
